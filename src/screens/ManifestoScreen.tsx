...
const MANIFESTO_PILLARS = [
  { icon: '🗽', num: 1, title: 'Digital Freedom', tagline: 'Free, open, uncensored internet as a human right.', color: Colors.gold },
  { icon: '☮️', num: 2, title: 'World Peace', tagline: 'Binding arbitration before any military action.', color: Colors.teal },
  { icon: '⚖️', num: 3, title: 'Justice & Human Rights', tagline: 'One law for every human. No immunity for anyone.', color: Colors.purple },
  { icon: '🌱', num: 4, title: 'Ecological Revolution', tagline: '100% renewable energy by 2045. No exceptions.', color: Colors.green },
  { icon: '🏥', num: 5, title: 'Health For All', tagline: 'Walk in, get treated, never billed beyond means.', color: Colors.red },
  { icon: '📚', num: 6, title: 'Education as Liberation', tagline: 'Free — birth through university. Debt-free. Everywhere.', color: Colors.teal },
  { icon: '💰', num: 7, title: 'Economic Revolution', tagline: 'UBI for all. Wealth cap $10B. 4-day work week.', color: Colors.gold },
  { icon: '🤝', num: 8, title: 'Cultural Freedom & Equality', tagline: 'Every identity deserves full legal protection.', color: Colors.purple },
  { icon: '🤖', num: 9, title: 'Technology for Humanity', tagline: 'AI serves people. Never to surveil or control.', color: Colors.teal },
  { icon: '🏛️', num: 10, title: 'Democratic Revolution', tagline: 'Liquid democracy. Blockchain voting. Instant recall.', color: Colors.gold },
  { icon: '🌐', num: 11, title: 'Equal Nations Doctrine', tagline: 'USA and Nepal vote identically. Always.', color: Colors.green },
  { icon: '🔐', num: 12, title: "Verified People's Democracy", tagline: 'ZK Proofs: proves humanity without revealing identity.', color: Colors.purple },
];
          ...
          >
            ...
            {expanded === p.num && (
              <View style={[styles.pillarExpanded, { borderTopColor: p.color + '33' }]}>
                <Text style={styles.pillarNote}>
                  Full policy details for Pillar {p.num} · Binding deadline enforced by DAO smart contracts · Downloadable from IPFS
                </Text>
              </View>
            )}
          </GlassCard>
...
const styles = StyleSheet.create({
  ...
  pillarNote: { color: Colors.textMuted, fontSize: Typography.size.xs, lineHeight: 18 },
